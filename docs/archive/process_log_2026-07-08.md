...
> **Historical archive.** This log preserves work performed through
> 2026-07-08. Later analysis changed the adopted transit solution, completed
> additional controls, and replaced the release workflow. Current state is
> documented in `../../REVIEW_NOTES.md`,
> `../../outputs/release_status.json`, and the canonical manuscript
