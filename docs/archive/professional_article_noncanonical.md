...
> **Historical noncanonical draft.** This Markdown manuscript is retained only
> for provenance. Its values, claims, figures, and workflow are superseded and
> must not be used for submission, citation, or release metadata. The sole
> canonical manuscript is `../../toi3492_characterization.tex`.
