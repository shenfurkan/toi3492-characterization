...
- Implication for TOI-3492.01: the current odd/even and secondary-eclipse tests are not enough for validation; at least Gaia neighbor inspection and a limitation statement about missing source-localization evidence are needed.
