...
REQUIRED.extend([
    ...
    "data/toi3492_raw_chain_window_total13h.npy",
    ...
    "outputs/faz6_residual_acf.csv",
    "outputs/faz6_residual_acf_v2.csv",
    "outputs/faz6_residual_beta.csv",
    "outputs/faz6_residual_beta_v2.csv",
    "outputs/faz6_residual_periodogram.csv",
    "outputs/faz6_residual_periodogram_v2.csv",
    "outputs/faz6_residual_peaks.csv",
    "outputs/faz6_residual_peaks_v2.csv",
