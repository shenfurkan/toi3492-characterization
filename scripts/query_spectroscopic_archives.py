...
md_lines.extend([
    ...
    f"- Fitted a/Rstar = 10.60",
    f"- If archive logg is **lower** than {tic_logg:.4f}, the stellar density and predicted a/Rstar decrease, so the tension with the larger transit value increases.",
    f"- If archive logg is **higher** than {tic_logg:.4f}, the predicted a/Rstar increases and the tension can decrease.",
    "",
    "## Interpretation",
    "",
])
